...
- **`archives/`** — *the cold one*: one folder per closed stage *(`000--2026-07-conception/`, `000--2026-07-tests-grandeur-nature/`, `000--2026-07-template-sous-git/`)*, each **synthesized** *(what/how/why)*. The three pieces of research that settled things live in **`archives/conception/`**.
...
- **`archives/`** — *le froid* : un dossier par étape close *(`000--2026-07-conception/`, `000--2026-07-tests-grandeur-nature/`, `000--2026-07-template-sous-git/`)*, chacune **synthétisée** *(quoi/comment/pourquoi)*. Les trois recherches qui ont tranché vivent dans **`archives/conception/`**.
