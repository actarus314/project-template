...
**The three rhythms — what triggers each, what runs in it, and how to stretch the longest one — live in [`docs/METHODE.md`](docs/METHODE.md), and nowhere else.** They were once written out here too, with a duration that had drifted to less than half the measured one.
