...
#   only grants access to what is already public. WRITE PATs, on the other hand, are 90 days.)
...
**Permissions (uniform standard — full matrix: https://github.com/actarus314/project-template/blob/main/docs/secrets-and-auth.md)**:
  - Contents: Read & Write
...
**Duration**: **90 days**, every new PAT.
